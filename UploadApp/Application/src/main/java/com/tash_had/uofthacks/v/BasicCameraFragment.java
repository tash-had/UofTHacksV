...
//    private File mFile;
                ...
                case STATE_WAITING_LOCK: {
                    ...
                    if (afState == null) {
                        captureStillPicture();
                            ...
                            CaptureResult.CONTROL_AF_MODE_AUTO== afState) {
    ...
    public static BasicCameraFragment newInstance() {
        return new BasicCameraFragment();
    }
...
//                Size sizeOfRender = new Size(1280, 720);
    ...
    /**
     * Opens the camera specified by {@link BasicCameraFragment#mCameraId}.
     */
...
//                    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.info: {
                Activity activity = getActivity();
                continueCaptureLoop = false;
                if (null != activity) {
                    Toast.makeText(activity.getApplicationContext(), "Shutter Stopped", Toast.LENGTH_SHORT).show();
